...
public class Wiki_StepDefinitions {
    ...
    public void userSeesIsInTheMainHeader(String string) {
        Assert.assertTrue(wikiSearchPage.headerText.isDisplayed());
        Assert.assertTrue(wikiSearchPage.headerText.getText().equals(string));

    }

    @Then("User sees {string} is in the image header")
    public void userSeesIsInTheImageHeader(String string) {
        Assert.assertEquals(string,wikiSearchPage.imageText.getText());
    }
}
